            ...
            <div className="bg-white/10 backdrop-blur-sm p-4 rounded-2xl mt-6 border border-white/20">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
                ...
                <label
                  ...
                  className="border-2 border-dashed border-cyan-400/50 rounded-xl p-4 text-center bg-white/5 hover:bg-white/10 transition-colors cursor-pointer block"
                >
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-cyan-400 text-sm font-medium hover:text-cyan-300">
                      Take Photo
                    </span>
            ...
            <div className="bg-white/10 backdrop-blur-sm p-4 rounded-2xl mt-6 border border-white/20">
              ...
              <div className="flex items-start space-x-3">
                <input
                  ...
                  onChange={handleInputChange}
                  className="mt-1 w-5 h-5 text-cyan-400 border-[3px] border-gray-300 rounded focus:ring-cyan-400 cursor-pointer flex-shrink-0 bg-white/10"
                  style={{ minWidth: '20px', minHeight: '20px' }}
                />
                <label htmlFor="agreeToTerms" className="text-xs text-gray-300 leading-relaxed cursor-pointer">
                  I consent to the <Link href="/terms"><span className="text-cyan-400 underline cursor-pointer">Terms & Conditions</span></Link> and understand that the ShroomTopia's products are 
                  intended for adults and may not be suitable for everyone. I agree to the 
                  <Link href="/terms"><span className="text-cyan-400 underline cursor-pointer"> Terms of Service</span></Link> and <Link href="/privacypolicy"><span className="text-cyan-400 underline cursor-pointer"> Privacy Policy</span></Link>.
                </label>
              </div>
            </div>
