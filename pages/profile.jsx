      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 space-y-6">
            ...
            {profile.subscriptionStatus === 'paused' && (
              <div className="bg-white/5 backdrop-blur-[1px] rounded-2xl p-6 border border-orange-500/50">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h3 className="text-orange-400 font-semibold text-lg mb-2">Subscription Paused by Admin</h3>
                    <p className="text-gray-300 text-sm mb-4">
                      Your Topia Circle subscription has been paused by our admin team. Please contact our support team for more information and to resolve this issue.
                    </p>
                    <div className="flex gap-3">
                      <a 
                        href="tel:313-231-8760" 
                        className="text-sm px-4 py-2 bg-orange-500/30 hover:bg-orange-500/40 text-orange-200 rounded-lg transition-colors font-medium"
                      >
                      Call Support
                      </a>
                      <a 
                        href="mailto:Mytopiadetroit@gmail.com" 
                        className="text-sm px-4 py-2 bg-orange-500/30 hover:bg-orange-500/40 text-orange-200 rounded-lg transition-colors font-medium"
                      >
                         Email Support
                      </a>
